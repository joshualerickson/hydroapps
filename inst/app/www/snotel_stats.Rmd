...
```{r, echo=FALSE,warning=F, error=F, message=F,  fig.align='center', fig.height=5, fig.width=9}
  ...
  dv_rep <- wildlandhydRo::reportSNOTELdv(snotel_ggplot_data_not_filtered(),days = 3)
  if(is.null(dv_rep)){
...
```{r, echo=FALSE,warning=F, error=F, message=F, fig.align='center', fig.height=6, fig.width=10}
  mv_rep <- wildlandhydRo::reportSNOTELmv(snotel_ggplot_data_not_filtered())
...
# per_stuff_df <- snotel_ggplot_data_not_filtered() %>% 
...
all_year <- snotel_ggplot_data_not_filtered()  %>% 
