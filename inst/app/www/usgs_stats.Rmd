...
```{r, echo=FALSE,warning=F, error=F, message=F, results='hide', fig.align='center', fig.height=6, fig.width=10}
if(dv_report[1,]$Station %in% 'Tobacco River near Eureka MT'){

  wildlandhydRo::plot_USGSdrought(usgs_ggplot_data_not_filtered(),
                                rolln = 1, 
  ...
  wildlandhydRo::plot_reportUSGS(dv_report) +
    ggplot2::theme(axis.text.x = ggplot2::element_text(size = 10),
        axis.text.y = ggplot2::element_text(size = 10))
}
...
usgs_ggplot_data_not_filtered() %>% wildlandhydRo::wyUSGS() %>% 
